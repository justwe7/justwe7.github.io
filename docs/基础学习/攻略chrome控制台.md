...
![image.png](/images/2020/06/28/image.png)
...
![image344c2.png](/images/2020/06/28/image344c2.png)
...
![image.png](/images/2020/07/19/image.png)
...
![imagebabdf.png](/images/2020/06/28/imagebabdf.png)
...
console.table(arr)
```
![imageab741.png](/images/2020/06/28/imageab741.png)
...
console.dir(obj)
```
![image688f0.png](/images/2020/06/28/image688f0.png)

打印 DOM 对象区别：   
![imagef2bad.png](/images/2020/06/28/imagef2bad.png)
...
```
![image68db1.png](/images/2020/06/28/image68db1.png)
...
console.groupEnd()
```
![image4d2c2.png](/images/2020/06/28/image4d2c2.png)

### $ 选择器
#### $_
可以记录上次计算的结果，直接用于代码执行:

![20200628_171742.gif](/images/2020/06/28/20200628_171742.gif)

#### $0,$1...$4
代表最近5个审查元素**选中**过的DOM节点，看图（是要选中一下，我更喜欢用存储全局变量的方式玩，省的自己手残又选了一个节点）：

![20200628_164937.gif](/images/2020/06/28/20200628_164937.gif)
...
![image538c8.png](/images/2020/06/28/image538c8.png)
...
1.  
![image6a303.png](/images/2020/06/28/image6a303.png)

2.  
![20200628_185451.gif](/images/2020/06/28/20200628_185451.gif)
...
![image1154d.png](/images/2020/06/28/image1154d.png)
...
![20200628_191941.gif](/images/2020/06/28/20200628_191941.gif)


#### 将某个元素存储到全局临时变量中
选中节点，右键，`Store as global variable`（在network面板中也能用，尤其是筛选接口的返回值很方便）

![20200628_192801.gif](/images/2020/06/28/20200628_192801.gif)

#### 滚动到某个节点
如果页面很长，想找一个文本节点的显示位置又不想手动滑动可以试试 `Scroll into view`

![20200628_190729.gif](/images/2020/06/28/20200628_190729.gif)


#### Edge 专属的3D视图
使用 chromium 后的 Edge 真的是改头换面，**3D 视图**可以帮忙定位一些定位层级还有DOM嵌套的问题，页面结构写的好不好看很直观的可以看出来(跟辅助功能里面的dom树结合使用很舒服)

![20200628_194515.gif](/images/2020/06/28/20200628_194515.gif)
...
![20200628_192344.gif](/images/2020/06/28/20200628_192344.gif)
...
按区域划分大概分为如下几个区域：  
![QQ20200719120526.png](/images/2020/07/19/QQ20200719120526.png)
...
![imagee28b2.png](/images/2020/07/04/imagee28b2.png)
...
![2021-03-0415.04.53.gif](/images/2021/03/04/2021-03-0415.04.53.gif)
...
![image85eb1.png](/images/2020/07/05/image85eb1.png)
...
![20200705_111751.gif](/images/2020/07/05/20200705_111751.gif)


#### Size 和 Time 为什么有两行参数？
![image08194.png](/images/2020/07/05/image08194.png)
...
#### Waterfall
点击某个资源会展示出详细的网络加载信息：
<!-- ![image2e1ab.png](/images/2020/07/05/image2e1ab.png) -->

![image143a7.png](/images/2020/07/19/image143a7.png)
...
![image7dd79.png](/images/2020/07/05/image7dd79.png)


### (5) Summary 区域

![imagef7b67.png](/images/2020/07/09/imagef7b67.png)
...
![image4af35.png](/images/2020/07/05/image4af35.png)

当页面完全加载时触发 `load` 事件。 它显示也显示在：
- 在 Overview (概览)窗格的红色垂直线表示这个事件。
- 在 Requests Table (请求列表)中的红色垂直线也表示这个事件。
- 在 Summary (概要)中，可以查看改事件的确切时间
![imagee4d7e.png](/images/2020/07/05/imagee4d7e.png)
...
![一系列被阻塞的请求](/images/2020/07/05/imageef7ae.png)
...
![高TTFB示例](/images/2020/07/05/image23444.png)
...
![高TTFB示例](/images/2020/07/05/imageae084.png)
...
![20200705_114001.gif](/images/2020/07/05/20200705_114001.gif)

### 设置断点

#### 断点的面板

![image.png](/images/2020/07/07/image.png)

![image0187f.png](/images/2020/07/06/image0187f.png)
...
![20200709_225251.gif](/images/2020/07/09/20200709_225251.gif)


#### 全局事件中断
假如不知道代码执行的位置，如以下场景：

![imagee7a93.png](/images/2020/07/06/imagee7a93.png)

看接口返回的列表总数应该是20条，但是页面到15条就显示到底部了


![imagecc38e.png](/images/2020/07/06/imagecc38e.png)
...
2. 然后提拉加载页面触发接口请求，如预期的，代码中断执行了。但提示找不到sourcemap，暂时把js的资源映射给关掉[(相关解决方式)](https://stackoverflow.com/questions/61767538/devtools-failed-to-load-sourcemap-for-webpack-node-modules-js-map-http-e)：
  ![imageaadd2.png](/images/2020/07/06/imageaadd2.png)
  ![imaged604f.png](/images/2020/07/06/imaged604f.png)
3. 再次触发断点，发现可以查看到中断的代码了，因为肯定是页面中的业务代码将请求推入到执行堆栈的，所以可以在堆栈中找到对应的方法名：`getVideoList`
   
   ![image003b6.png](/images/2020/07/06/image003b6.png)
4. 点击方法名可以跳转到对应的源码，可以看到圈起来的代码和所猜想的问题代码应该是同一处
  ![imageb8ea4.png](/images/2020/07/06/imageb8ea4.png)
5. 回过来看下问题原因： 页面请求完新数据后直接 `pageNum` 自增，然后直接就用于是否结束的判断了，有点不够严谨，不如直接比对当前的列表长度与接口返回的数据总数来判断: 
   ![imaged4077.png](/images/2020/07/06/imaged4077.png)
6. 记住要修改的代码，在这个文件开头，也就是 `191.xxx.js` 
   1. 第一行先打个断点，push 方法之前再打一个断点: ![image.png](/images/2020/07/09/image.png) (如果没有再刷新一下(也不清楚为什么可能会没有))
...
![imagea80ad.png](/images/2020/07/06/imagea80ad.png)
...
默认（不开启黑盒）：  
![image70101.png](/images/2020/07/06/image70101.png)

开启黑盒：  
![imagec7749.png](/images/2020/07/06/imagec7749.png)
...
![imagef4dfb.png](/images/2020/07/07/imagef4dfb.png)
...
### (2)overview 总览区域
![imagee53ec.png](/images/2020/07/07/imagee53ec.png)
...
![image10bff.png](/images/2020/07/07/image10bff.png)

#### 看到的几条虚线：
![20200708_184105.gif](/images/2020/07/08/20200708_184105.gif)
...
![image.png](/images/2020/07/08/image.png)
...
![20200708_191952.gif](/images/2020/07/08/20200708_191952.gif)
...
![imagee4183.png](/images/2020/07/09/imagee4183.png)
...
![image258e7.png](/images/2020/07/09/image258e7.png)
...
![imagee8ea4.png](/images/2020/07/08/imagee8ea4.png)
...
- 点击`reload` 按钮开始检测 ![image1719a.png](/images/2020/07/20/image1719a.png)  
- 点击相应文件即可查看具体的覆盖情况（蓝色的为用到的代码，红色表示没有用到的代码）!![image.png](/images/2020/07/20/image.png)
...
![20200709_171307.gif](/images/2020/07/09/20200709_171307.gif)
