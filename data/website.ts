...
export const websiteData: WebsiteCategory[] = [
  ...
  },
  {
    ...
    websites: [
      ...
      },
      {
        name: 'JSDoc规范',
        desc: '手册网，在线文档',
        logo: 'https://www.shouce.ren/favicon.ico',
        href: 'https://www.shouce.ren/api/view/a/13311',
        tags: ['文档'],
      },
    ],
  },
  {
    ...
    websites: [
      ...
      },
      {
        ...
        logo: '/img/website/terminalgif.ico',
    ...
    websites: [
      {
        ...
        logo: 'https://s2.loli.net/2023/02/03/uKUNcZFdb1C9Vw8.png',
  ...
  },
  {
    ...
    websites: [
      ...
      },
      {
        name: 'npmtrends',
        desc: 'npm 包下载量趋势图对比',
        logo: 'https://npmtrends.com/images/logos/npm_trends_logo.png',
  ...
  },
  {
    ...
    websites: [
      ...
      {
        name: 'icomoon',
        desc: '提供了一些矢量图标，用于制作自定义图标字体或SVG Sprites',
        logo: 'https://icomoon.io/app/favicon.ico',
